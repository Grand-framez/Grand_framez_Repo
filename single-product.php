                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="product-breadcroumb">
                            ...
                            <a href="single-product.php">Headshot - Photography</a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name">Headshot - Photography</h2>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                <h2>Description</h2>  
                                                <p>A headshot is a photograph of a person’s face, that usually includes their shoulders. It can be taken from different angles and is usually used in a professional context, like on social media or professional website. It usually only includes one person, and they are the main subject in your photo.</p>

                                                <p>The difference between a headshot and a portrait is that a headshot usually only includes the face, while a portrait may include the body as well. Make sure you know what your client expects because people often use the words interchangeably.</p>
                                            </div>
                        ...
                        <div class="related-products-wrapper">
                            <h2 class="related-products-title">Related Services</h2>
