...
if(isset($_REQUEST['passupdate'])){
    ...
    $rPass = $_REQUEST['newpassword'];
    if ($rPass !== $passwordRepeat) {
        $passmsg = "<div class='alert alert-danger col-sm-6 ml-5 mt-2'> Password do not match..!!</div>";
    }
    else if($_REQUEST['newpassword'] == ""){
        $passmsg = "<div class='alert alert-danger col-sm-6 ml-5 mt-2'> Fill ALL Fields..!!</div>";
    } else {
        
        $hashedpwd = password_hash($rPass, PASSWORD_DEFAULT);
        $sql = "UPDATE users SET pwdUsers = '$hashedpwd' WHERE emailUsers = '$rEmail'";
...
<div class="form" style="margin-top: -130px";>
    ...
    <input type="email" id="email" value="<?php echo $rEmail; ?>" readonly>
    </div>
    ...
    <div class="field-wrap" class="form-group">
            ...
            <input type="password" name="newpassword" id="inputnewpassword" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap" class="form-group">
           ...
           Repeat-New Password<span class="req">*</span>
            ...
            <input type="password" name="pwd-repeat" id="inputnewpassword" required autocomplete="off"/>
          </div>
          

          <button type="submit" name="passupdate" class="button button-block"/>Update</button>
