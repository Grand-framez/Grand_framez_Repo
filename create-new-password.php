...
if (empty($selector) || empty($validator)) {
    ...
    if (ctype_xdigit($selector) !== false && ctype_xdigit($validator) !== false) {
        ?>
                <div class="form">
    <ul class="tab-group">
        <li class="tab active"><a href="#reset password">reset password</a></li>
      </ul>
        <div id="login">   
          ...
          <div class="field-wrap">
            <label>
              Enter your new password<span class="req">...</span>
            </label>
            <input type="hidden" name="selector" value="<?php echo $selector ?>" required autocomplete="off"/>
            <input type="hidden" name="validator" value="<?php echo $validator ?>" required autocomplete="off"/>
            <input type="password" name="pwd" required autocomplete="off"/>
          </div>
          <div class="field-wrap">
            <label>
              Enter your new password Again!!<span class="req">...</span>
            </label>
            <input type="hidden" name="selector" value="<?php echo $selector ?>" required autocomplete="off"/>
            <input type="hidden" name="validator" value="<?php echo $validator ?>" required autocomplete="off"/>
            <input type="password" name="pwd-repeat" required autocomplete="off"/>
          </div>
          <button type="submit" name="reset-password-submit" class="button button-block"/>Reset password</button>
