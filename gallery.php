...
<head>
  ...
  <title>Grand FrameZ Gallery</title>
...
<div class="container gallery-container">
    ...
    <p class="page-description text-center">Find perfect Photos from us here..!!</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                <a class="lightbox" href="img/img8.jpg">
                    <img src="img/img8.jpg" alt="bride">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img5.jpg">
                    <img src="img/img5.jpg" alt="mahendi">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img7.jpg">
                    <img src="img/img7.jpg" alt="Traditional">
                </a>
            </div>
            <div class="col-sm-12 col-md-8">
                <a class="lightbox" href="img/img2.jpg">
                    <img src="img/img2.jpg" alt="sunset">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img3.jpg">
                    <img src="img/img3.jpg" alt="dance">
                </a>
            </div> 
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img4.jpg">
                    <img src="img/img4.jpg" alt="wedding">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img6.jpg">
                    <img src="img/img6.jpg" alt="wedding">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img12.jpg">
                    <img src="img/img12.jpg" alt="mother-son">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img11.jpg">
                    <img src="img/img11.jpg" alt="mum love">
                </a>
            </div>
            <div class="col-sm-12 col-md-12">
                <a class="lightbox" href="img/img1.jpg">
                    <img src="img/img1.jpg" alt="wedding">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img10.jpg">
                    <img src="img/img10.jpg" alt="byron bay">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img9.jpg">
                    <img src="img/img9.jpg" alt="event">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img20.jpg">
                    <img src="img/img20.jpg" alt="husband wife">
                </a>
            </div>
            <div class="col-sm-12 col-md-8">
                <a class="lightbox" href="img/img22.jpg">
                    <img src="img/img22.jpg" alt="dance">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img18.jpg">
                    <img src="img/img18.jpg" alt="brisbane">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img17.jpg">
                    <img src="img/img17.jpg" alt="event">
                </a>
            </div>
            <div class="col-sm-6 col-md-4">
                <a class="lightbox" href="img/img23.jpg">
                    <img src="img/img23.jpg" alt="dance">
                </a>
            </div>
        </div>
