...
<div class="text-center mainmenu-area" style="margin-top:50px; font-size:30px; color:white;">
...
if($result->num_rows > 0){
    echo '<table class="text-center table"style="background:#dff0d8; color:Black;">
    <thead>
    <tr>
