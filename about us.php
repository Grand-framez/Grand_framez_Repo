            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title">Welcome to Grand FrameZ</h2>
                    </div>
                    <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                <h2>who we are?</h2>  
                                                <p>Grand FrameZ is a Brisbane (Australia) based photography and cinematography company. After working on a short film project for a well know director from south Indian film industry we decided  to form our own company and named it Grand FrameZ.We're dedicated to giving you the very best service, with a focus on Photography and videography. So far we have worked on various projects like weddings, fashion runway, live function, advertisements, Portfolio shoots, community events, charity fund raiser shows and so on. We take every work seriously no matter whether it is small or big. Grand FrameZ team have creative directors, Editors,Hair and makeup artist, costume designers, photographers, cinematographers, stylist.</p>

                                                <p>"We do not consider camera as out third eye but our main eye".</p>
                                                <p>"If you have any questions please do not hesitate to <a href="contact.php">Contact us</a>" </p>
                                                
                                                
                                            </div>
                                            <iframe width="100%" height="600px" src="https://www.youtube.com/embed/wtza0WCiXqU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
